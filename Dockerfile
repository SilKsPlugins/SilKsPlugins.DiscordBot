...
RUN --mount=type=secret,id=github_token dotnet nuget add source --username SilKsPlugins --password $(cat /run/secrets/github_token) --store-password-in-clear-text --name github "https://nuget.pkg.github.com/SilKsPlugins/index.json"
